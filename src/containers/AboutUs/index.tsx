...
const AboutUs = () => {
  return (
    <section className="bg-black text-white mx-4 py-24 rounded-xl">
      <div className="container px-8">
        ...
        <p className="text-2xl">
          ...
          exceptional digital solutions. With a passion for crafting
          unforgettable experiences, we specialize in UI/UX design, web
          ...
          <span className="text-violet-100">
            ...
            meet the unique needs and goals of each client, ensuring
            unparalleled success and growth.
            <br />
            <br />
            ...
            dedication to pushing boundaries, we invite you to embark on a
            journey of creativity, innovation, and success with us.
          </span>
        </p>
