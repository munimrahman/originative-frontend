...
const Marquee: FC<MarqueeProps> = forwardRef(function Marquee(
      ...
      return [
        ...
        <Fragment key={i}>
          {Children.map(children, (child) => {
            return (
              <div style={childStyle} className={classes.rfmChild}>
                {child}
              </div>
            );
          })}
  ...
  return !isMounted ? null : (
    <div
      ...
      className={classes.rfmMarqueeContainer + " " + className}
    >
      {gradient && <div style={gradientStyle} className={classes.rfmOverlay} />}
      <div
        className={classes.rfmMarquee}
        style={marqueeStyle}
        onAnimationIteration={onCycleComplete}
        onAnimationEnd={onFinish}
      >
        <div className={classes.rfmInitialChildContainer} ref={marqueeRef}>
          {Children.map(children, (child) => {
            return (
              <div style={childStyle} className={classes.rfmChild}>
                {child}
      ...
      <div className={classes.rfmMarquee} style={marqueeStyle}>
